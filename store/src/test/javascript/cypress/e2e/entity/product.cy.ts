...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'pfft', price: 18629.84, addedDate: '2024-07-15' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="addedDate"]`).type('2024-07-15');
      cy.get(`[data-cy="addedDate"]`).blur();
      cy.get(`[data-cy="addedDate"]`).should('have.value', '2024-07-15');
